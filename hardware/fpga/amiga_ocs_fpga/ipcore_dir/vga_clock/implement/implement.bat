...
xst -ifn xst.scr
move vga_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\vga_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc vga_clock_exdes.ucf vga_clock_exdes

echo 'Running map'
map -timing -pr b vga_clock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm vga_clock_exdes -w routed.ncd routed.v
cd ..
